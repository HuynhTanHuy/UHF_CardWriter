...
| Smoke | `tools/Archive/Phase7BSmoke` _(removed — [ToolsHistory.md](ToolsHistory.md))_ |
...
`dotnet run --project tools/Archive/Phase7BSmoke` _(tool removed — [ToolsHistory.md](ToolsHistory.md))_ — historically DI resolve + MainForm create/show/close without hardware.
