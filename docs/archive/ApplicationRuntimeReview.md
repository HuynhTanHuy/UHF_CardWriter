...
| Smoke: DI resolve | `tools/Regression/Phase6DSmoke` _(removed — [ToolsHistory.md](ToolsHistory.md))_ |
| Smoke: mocked Write→Verify→Register | `tools/Regression/Phase6DSmoke` _(removed — [ToolsHistory.md](ToolsHistory.md))_ |
